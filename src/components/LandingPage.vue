    ...
    <div class="left-column">
      <div class="left-column-content">
        ...
        <div id="drag" :class="{'drag-over': isDragOver}">
            ...
            <a @click="selectFolder">Upuść tu plik zip</a> lub
            <a @click="selectFolder">otwórz gotowy testownik z repozytorium</a>
          </div>
        <div class="buttons">
          ...
          <button class="default-button" @click="$emit('showSettings')">
            <i>
