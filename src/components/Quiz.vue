  ...
  <div class="quiz-wrapper" :theme="theme">
    ...
    <div class="quiz-info-wrapper">
      ...
      <div class="quiz-info-wrapper-content">
        ...
        <div class="buttons">
          <button @click="tryQuitQuiz"><FontAwesomeIcon :icon="faPowerOff"/></button>
          <button v-if="quiz.location" @click="saveQuiz"><FontAwesomeIcon :icon="faSave"/></button>
          <button @click="$emit('showSettings')"><FontAwesomeIcon :icon="faCog"/></button>
          <button @click="$emit('showInfo')"><FontAwesomeIcon :icon="faInfo"/></button>
        </div>
      </div>
    </div>
  </div>
...
import {QuizContent} from "../store/types";
...
let unsortedAnswers = null
let quiz = quizObject
let showFinishModal = false
let isSelectOptionsModalOpened = false
let isSaveBeforeQuitQuizModalOpened = false
let isSaveBeforeQuitAppModalOpened = false
let answers = []
let selectAnswers = []
let selectObject = Object
let selectOptionsModalContent = null
