...
export function createSampleQuiz() {
  ...
  return {
    ...
    time: 0,
    reoccurrences: [
      { tag: '001.txt', value: settingsStore.reoccurrencesOnStart },
      { tag: '002.txt', value: settingsStore.reoccurrencesOnStart },
      { tag: '003.txt', value: settingsStore.reoccurrencesOnStart }
    ],
    questions: [{
      tag: '001.txt',
      contentType: 'text',
